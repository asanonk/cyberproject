...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        theConObj.Open();
        string theCmdStr = string.Format("Select * from Users where Username=N'{0}'", Request.QueryString["username"]);
        ...
        if (Request.Form["submitBtn"] != null)
        {
            ...
            if (name != "")
            {
                string cmdStr = string.Format("UPDATE Users SET Name = N'{0}' WHERE Username = N'{1}'", name, Request.QueryString["username"]);
                SqlCommand cmdObj = new SqlCommand(cmdStr, conObj);
            ...
            if (email != "")
            {
                string cmdStr = string.Format("UPDATE Users SET Email = N'{0}' WHERE Username = N'{1}'", email, Request.QueryString["username"]);
                SqlCommand cmdObj = new SqlCommand(cmdStr, conObj);
                cmdObj.ExecuteNonQuery();
            }
            if (phone != "")
            {
                string cmdStr = string.Format("UPDATE Users SET Phone = N'{0}' WHERE Username = N'{1}'", phone, Request.QueryString["username"]);
                SqlCommand cmdObj = new SqlCommand(cmdStr, conObj);
                cmdObj.ExecuteNonQuery();
            }
            if (gender != null)
            {
                string cmdStr = string.Format("UPDATE Users SET Gender = N'{0}' WHERE Username = N'{1}'", gender, Request.QueryString["username"]);
                SqlCommand cmdObj = new SqlCommand(cmdStr, conObj);
                cmdObj.ExecuteNonQuery();
            }
            if (BDDay != "Day")
            {
                string cmdStr = string.Format("UPDATE Users SET Birthday = N'{0}' WHERE Username = N'{1}'", (BDDay + "." + BDMonth + "." + BDYear), Request.QueryString["username"]);
                SqlCommand cmdObj = new SqlCommand(cmdStr, conObj);
                cmdObj.ExecuteNonQuery();
            }
            if (adress != "")
            {
                string cmdStr = string.Format("UPDATE Users SET Adress = N'{0}' WHERE Username = N'{1}'", adress, Request.QueryString["username"]);
                SqlCommand cmdObj = new SqlCommand(cmdStr, conObj);
                cmdObj.ExecuteNonQuery();
            }
            if (currentBestPlayer != null)
            {
                string cmdStr = string.Format("UPDATE Users SET CurrentBestPlayer = N'{0}' WHERE Username = N'{1}'", currentBestPlayer, Request.QueryString["username"]);
                SqlCommand cmdObj = new SqlCommand(cmdStr, conObj);
                cmdObj.ExecuteNonQuery();
            }
            if (bestPlayerEver != null)
            {
                string cmdStr = string.Format("UPDATE Users SET BestPlayerEver = N'{0}' WHERE Username = N'{1}'", bestPlayerEver, Request.QueryString["username"]);
                SqlCommand cmdObj = new SqlCommand(cmdStr, conObj);
                cmdObj.ExecuteNonQuery();
            }
            if (favoriteShoes != null)
            {
                string cmdStr = string.Format("UPDATE Users SET FavoriteShoesBrand = N'{0}' WHERE Username = N'{1}'", favoriteShoes, Request.QueryString["username"]);
                SqlCommand cmdObj = new SqlCommand(cmdStr, conObj);
                cmdObj.ExecuteNonQuery();
            }
            if (areYouPlayingBasketball != null)
            {
                string cmdStr = string.Format("UPDATE Users SET AreYouPlayingBasketball = N'{0}' WHERE Username = N'{1}'", areYouPlayingBasketball, Request.QueryString["username"]);
                SqlCommand cmdObj = new SqlCommand(cmdStr, conObj);
                cmdObj.ExecuteNonQuery();
            }
