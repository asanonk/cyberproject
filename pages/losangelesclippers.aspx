...
<asp:Content ID="Content8" ContentPlaceHolderID="logo" Runat="Server">
    <img src="../teams/losangelesclippers/losangelesclippersLogo.png" alt="losangelesclippers" width="270"/>
</asp:Content>
<asp:Content ID="Content9" ContentPlaceHolderID="arena" Runat="Server">
    <img src="../teams/losangelesclippers/losangelesclippersArena.jpg" alt="arena" width="270"/>
    Staples Center
</asp:Content>